...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Log.timestamp'
        db.add_column(u'content_log', 'timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Log.timestamp'
        db.delete_column(u'content_log', 'timestamp')


    models = {
        u'content.log': {
            'Meta': {'ordering': "(u'timestamp',)", 'object_name': 'Log'},
        ...
        u'content.path': {
            'Meta': {'object_name': 'Path', 'db_table': "u'paths'", 'managed': 'False'},
